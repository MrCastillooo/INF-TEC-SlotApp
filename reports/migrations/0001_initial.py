    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('establecimiento', models.CharField(default='NUEVO CASINO ALBERDI', max_length=100)),
                ...
                ('firma_tecnico', models.CharField(blank=True, max_length=100, null=True, verbose_name='Firma del Técnico')),
                ('firma_jefe_slot', models.CharField(blank=True, max_length=100, null=True, verbose_name='Firma del Jefe de Slot')),
                ('firma_encargado_sala', models.CharField(blank=True, max_length=100, null=True, verbose_name='Firma del Encargado de Sala')),
                ('firma_cajero', models.CharField(blank=True, max_length=100, null=True, verbose_name='Firma del Cajero')),
            ],
        ),
    ]
